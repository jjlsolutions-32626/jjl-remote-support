  ...
  Widget buildHelpCards(String updateUrl) {
    if (!bind.isCustomClient() &&
      ...
      GestureTapCallback onPressed = () async {
        final Uri url = Uri.parse('https://jjlsolutions.com/download');
        await launchUrl(url);
      };
      if (isToUpdate) {
        onPressed = () {
      ...
      return buildInstallCard(
          ...
          link: isToUpdate
              ? 'https://github.com/jjlsolutions-32626/jjl-remote-support/releases/tag/${bind.mainGetNewVersion()}'
              : null);
    }
    ...
    if (isWindows && !bind.isDisableInstallation()) {
      if (!bind.mainIsInstalled()) {
        ...
        // Disabled for JJL Remote Support custom build
        return buildInstallCard(
