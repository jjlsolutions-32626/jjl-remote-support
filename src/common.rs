...
// Update check disabled for custom JJL Remote Support build.
// The original code checked api.rustdesk.com which would prompt users
// to "upgrade" to stock RustDesk, breaking the custom build.
#[tokio::main(flavor = "current_thread")]
