...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("JJL Remote Support".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://jjlsolutions.com/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["216.36.192.101"];
pub const RS_PUB_KEY: &str = "CPeBf1+++1W92iaQXgY1nBYvwoozEWlhUc+KTmkV89A=";
